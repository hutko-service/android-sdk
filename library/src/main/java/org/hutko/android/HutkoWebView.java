...
public class HutkoWebView extends WebView implements HutkoView {
    ...
    public HutkoWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HutkoWebView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void loadProxy(PayConfirmation confirmation) {
        try {
            ...
            final String newHost = "3dse.org.hutko";
